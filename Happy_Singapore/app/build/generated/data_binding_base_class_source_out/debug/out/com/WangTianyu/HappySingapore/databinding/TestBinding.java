...
public final class TestBinding implements ViewBinding {
  ...
  private TestBinding(@NonNull LinearLayout rootView, @NonNull ImageView test) {
  ...
  public static TestBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.test;
      ImageView test = rootView.findViewById(id);
      if (test == null) {
        break missingId;
      }

      return new TestBinding((LinearLayout) rootView, test);
    }
